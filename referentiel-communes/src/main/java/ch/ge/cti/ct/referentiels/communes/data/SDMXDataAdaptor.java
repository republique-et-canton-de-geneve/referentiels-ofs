...
public class SDMXDataAdaptor extends
	 ...
	 * </ul>
	 * 
	 * @param workspace données SDMX parsées
	 */
	...
	private void populateHierarchy(final StructureWorkspace workspace) {
		...
		// 2. <structure:HierarchicalCodelist id="HCL_HGDE_HIST" version="1.0" agencyID="CH1_RN" validFrom="1960-01-01">
