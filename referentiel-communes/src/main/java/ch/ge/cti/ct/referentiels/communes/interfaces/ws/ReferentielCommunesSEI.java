...
public class ReferentielCommunesSEI implements ReferentielCommunesWS, Loggable
{
    ...
    {
	return FluentIterable.from(service.getCantons()).transform(new CantonConvert()).toList();
    }

    @Override
    @WebMethod(operationName = "getCanton", action = "getCanton")
    @WebResult(name = "canton")
    public CantonWS getCanton(@WebParam(name = "canton") final String codeCanton) throws ReferentielOfsException
    {
    ...
    public List<DistrictWS> getDistrictsByCanton(@WebParam(name = "canton") final String codeCanton)
	...
	return FluentIterable.from(service.getDistricts(codeCanton)).transform(new DistrictConvert()).toList();
    }

    @Override
    @WebMethod(operationName = "getDistrict", action = "getDistrict")
    @WebResult(name = "district")
    public DistrictWS getDistrict(@WebParam(name = "district") final int districtId) throws ReferentielOfsException
    {
	if (districtId <= 0)
	{
	    return null;
    ...
    public List<CommuneWS> getCommunesByDistrict(@WebParam(name = "district") final int districtId)
	    throws ReferentielOfsException
    {
	if (districtId <= 0)
	{
	...
	return FluentIterable.from(service.getCommunesByDistrict(districtId)).transform(new CommuneConvert()).toList();
    }
    ...
    @WebResult(name = "commune")
    @Cachable(name = "communes", size = Cachable.LARGE)
    public List<CommuneWS> getCommunesByCanton(@WebParam(name = "canton") final String codeCanton)
	    throws ReferentielOfsException
    {
	if (StringUtils.isBlank(codeCanton))
	{
	...
	return FluentIterable.from(service.getCommunesByCanton(codeCanton)).transform(new CommuneConvert()).toList();
    }
    ...
    @WebResult(name = "commune")
    @Cachable(name = "communes", size = Cachable.LARGE)
    public List<CommuneWS> getCommunesHistoriquesByCanton(@WebParam(name = "canton") final String codeCanton)
	    throws ReferentielOfsException
    {
	if (StringUtils.isBlank(codeCanton))
	{
	...
	return FluentIterable.from(service.getCommunesHistoriquesByCanton(codeCanton)).transform(new CommuneConvert())
		.toList();
    }
    ...
    @WebResult(name = "commune")
    public CommuneWS getCommune(@WebParam(name = "commune") final int communeId) throws ReferentielOfsException
    {
	if (communeId <= 0)
	{
	    return null;
    ...
    @WebResult(name = "canton")
    public CantonWS getCantonDate(@WebParam(name = "canton") final String codeCanton,
	    @WebParam(name = "dateValid") final Date dateValid) throws ReferentielOfsException
    {
	if (StringUtils.isBlank(codeCanton))
	{
	    return null;
	}
	return new CantonConvert().apply(service.getCanton(codeCanton, dateValid));
    }

    @Override
    @WebMethod(operationName = "getCantonsDate", action = "getCantonsDate")
    @WebResult(name = "canton")
    public List<CantonWS> getCantonsDate(@WebParam(name = "dateValid") final Date dateValid)
	    throws ReferentielOfsException
    {
	return FluentIterable.from(service.getCantons(dateValid)).transform(new CantonConvert()).toList();
    }

    @Override
    @WebMethod(operationName = "getDistrictDate", action = "getDistrictDate")
    @WebResult(name = "district")
    public DistrictWS getDistrictDate(@WebParam(name = "district") final int districtId,
	    @WebParam(name = "dateValid") final Date dateValid) throws ReferentielOfsException
    {
	if (districtId <= 0)
	{
	...
	return new DistrictConvert().apply(service.getDistrict(districtId, dateValid));
    }

    @Override
    @WebMethod(operationName = "getDistrictsByCantonDate", action = "getDistrictsByCantonDate")
    @WebResult(name = "district")
    public List<DistrictWS> getDistrictsByCantonDate(@WebParam(name = "canton") final String codeCanton,
	    @WebParam(name = "dateValid") final Date dateValid) throws ReferentielOfsException
    {
	if (StringUtils.isBlank(codeCanton))
	{
	...
	return FluentIterable.from(service.getDistricts(codeCanton, dateValid)).transform(new DistrictConvert())
		.toList();
    }
    ...
    @WebResult(name = "commune")
    public List<CommuneWS> getCommunesByDistrictDate(@WebParam(name = "district") final int districtId,
	    @WebParam(name = "dateValid") final Date dateValid) throws ReferentielOfsException
    {
	if (districtId <= 0)
	{
	...
	return FluentIterable.from(service.getCommunesByDistrict(districtId, dateValid)).transform(new CommuneConvert())
		.toList();
    }
    ...
    @WebResult(name = "commune")
    public List<CommuneWS> getCommunesByCantonDate(@WebParam(name = "canton") final String codeCanton,
	    @WebParam(name = "dateValid") final Date dateValid) throws ReferentielOfsException
    {
	if (StringUtils.isBlank(codeCanton))
	{
	...
	return FluentIterable.from(service.getCommunesByCanton(codeCanton, dateValid)).transform(new CommuneConvert())
		.toList();
    }
    ...
    @WebResult(name = "commune")
    public List<CommuneWS> searchCommune(@WebParam(name = "critere") final String critere)
	    throws ReferentielOfsException
    {
	...
	return FluentIterable.from(service.searchCommune(critere)).transform(new CommuneConvert()).toList();
    }

    @Override
    @WebMethod(operationName = "searchCommuneDate", action = "searchCommuneDate")
    @WebResult(name = "commune")
    public List<CommuneWS> searchCommuneDate(@WebParam(name = "critere") final String critere,
	    @WebParam(name = "dateValid") final Date dateValid) throws ReferentielOfsException
    {
	if (StringUtils.isBlank(critere))
	{
	...
	return FluentIterable.from(service.searchCommune(critere, dateValid)).transform(new CommuneConvert()).toList();
    }

    @Override
    @WebMethod(operationName = "searchCommuneRegexp", action = "searchCommuneRegexp")
    @WebResult(name = "commune")
    public List<CommuneWS> searchCommuneRegexp(@WebParam(name = "regexp") final String regexp)
	    throws ReferentielOfsException
    {
	...
	return FluentIterable.from(service.searchCommuneRegexp(regexp)).transform(new CommuneConvert()).toList();
    }

    @Override
    @WebMethod(operationName = "searchCommuneDateRegexp", action = "searchCommuneDateRegexp")
    @WebResult(name = "commune")
    public List<CommuneWS> searchCommuneDateRegexp(@WebParam(name = "regexp") final String regexp,
	    @WebParam(name = "dateValid") final Date dateValid) throws ReferentielOfsException
    {
	if (StringUtils.isBlank(regexp))
	{
	...
	return FluentIterable.from(service.searchCommuneRegexp(regexp, dateValid)).transform(new CommuneConvert())
		.toList();
    }
