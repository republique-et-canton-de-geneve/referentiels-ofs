...
public class RefSearchRegexpTest extends AbstractRefWSTest {
	...
	if (dateValid == null) {
	    communes = getWS().searchCommuneRegexp(search);
	} else {
	    communes = getWS().searchCommuneDateRegexp(search, dateValid);
	}
