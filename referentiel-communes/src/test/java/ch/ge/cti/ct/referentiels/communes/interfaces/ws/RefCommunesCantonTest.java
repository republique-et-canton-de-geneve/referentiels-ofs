...
public class RefCommunesCantonTest extends AbstractRefWSTest {
	...
	if (dateValid == null) {
	    communes = getWS().getCommunesByCanton(cantonCode);
	} else {
	    communes = getWS().getCommunesByCantonDate(cantonCode, dateValid);
	}
