...
public class SDMXParser {
     ...
     * 
     * @param structureParsingManager
     *            parseur SDMX
     * @param rdlFactory
     *            factory de reader de fichier SDMX
     */
    @Autowired(required = true)
    public SDMXParser(final StructureParsingManager structureParsingManager,
     ...
     */
    public StructureWorkspace parse(final URI urlSDMX) {
