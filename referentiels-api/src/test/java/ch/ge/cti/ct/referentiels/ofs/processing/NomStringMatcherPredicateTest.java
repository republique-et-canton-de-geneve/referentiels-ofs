...
public class NomStringMatcherPredicateTest {
	...
	assertTrue(predicate.apply(new TestComplexType(0, null)));
	assertTrue(predicate.apply(new TestComplexType(0, "")));
	assertFalse(predicate.apply(new TestComplexType(0, "a")));
	assertFalse(predicate.apply(new TestComplexType(0, "abc")));
	assertFalse(predicate.apply(new TestComplexType(0, "abcdef")));
	...
	predicate = new NomStringMatcherPredicate("abcdef");
	assertTrue(predicate.apply(new TestComplexType(0, "abcdef")));
	assertTrue(predicate.apply(new TestComplexType(0, "àbcdef")));
	assertTrue(predicate.apply(new TestComplexType(0, "äbcdef")));
	assertTrue(predicate.apply(new TestComplexType(0, "abcdéf")));
	assertTrue(predicate.apply(new TestComplexType(0, "àbcdèf")));
	assertTrue(predicate.apply(new TestComplexType(0, "äbcdëf")));
	assertTrue(predicate.apply(new TestComplexType(0, "ÀBCDEF")));
    }
}
