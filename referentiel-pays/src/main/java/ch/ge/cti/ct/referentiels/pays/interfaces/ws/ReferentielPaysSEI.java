...
import ch.ge.cti.ct.referentiels.pays.service.ReferentielPaysService;
import ch.ge.cti.ct.referentiels.pays.service.impl.ReferentielPaysServiceImpl;
...
public class ReferentielPaysSEI implements
    ReferentielPaysTerritoiresWS, Loggable {

    private static final Logger LOG = LoggerFactory.getLogger(ReferentielPaysSEI.class);

    private final ReferentielPaysService service = new ReferentielPaysServiceImpl();
    ...
    public PaysWS getPaysByIso2(@WebParam(name = "iso2") String iso2) throws ReferentielOfsException {
        try {
            ...
            return c.map(obj -> new CountryConverter().apply(obj))
                    .orElse(null);
        } catch (RuntimeException e) {
            throw processException(e);
        }
    ...
    /**
     * Methode partagee de traitement des exceptions<br/>
     * Les exceptions sont encapsulees dans une ReferentielPaysTerritoiresException<br/>
     * Sauf si ce sont deja des ReferentielPaysTerritoiresException
     * 
     * @param e exception
     * @return ReferentielPaysTerritoiresException exception encapsulee
     */
