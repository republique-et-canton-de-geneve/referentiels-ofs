...
class CountriesLoader {
    ...
    private void fixCountries() {
        fixKosovo();
        fixPalestine();
        fixShortName("Brunéi Darussalam", "Brunéi");
        fixShortName("Bélarus", "Biélorussie");
        fixShortName("Bosnie et Herzégovine", "Bosnie-Herzégovine");
        fixShortName("Cabo Verde", "Cap-Vert");
        fixShortName("Cité du Vatican", "Vatican");
        fixShortName("Corée (Nord)", "Corée du Nord");
        fixShortName("Corée (Sud)", "Corée du Sud");
        fixShortName("El Salvador", "Salvador");
        fixShortName("Emirats arabes unis", "Émirats arabes unis");
        ...
        fixShortName("Taïwan (Taipei chinois)", "Taïwan");
    ...
    private void fixPalestine() {
        ...
        if (StringUtils.isBlank(c.getOfficialNameFr())) {
            c.setOfficialNameFr("État de Palestine");
        }
    }
