...
public interface ReferentielPaysTerritoiresServiceAble {
	 ...
	 * 
	 * @param continentId identifiant de continent
	 ...
	 * 
	 * @param regionId identifiant de region (numérique)
	 * @return objet region
	 * @throws ReferentielOfsException erreur de traitement
	 */
	 ...
	 * 
	 * @param continentId identifiant de continent (2 caractères alpha)
	 ...
	 * liste des pays
	 * 
	 * @param idPays identifiant de la pays
	 * @return pays
	 * @throws ReferentielOfsException erreur de traitement
	 */
